var AbilitiesData = {
  ...
  "Embody Aspect": {
    "name": "Embody Aspect",
    "description": "Boosts Attack/Defense/Sp. Def/Speed depending on the form.",
    "generation": "9"
  },
  "Emergency Exit": {
    "name": "Emergency Exit",
  ...
  "Hospitality": {
    "name": "Hospitality",
    "description": "Partially restores an ally's HP when it enters a battle.",
    "generation": "9"
  },
  "Huge Power": {
    "name": "Huge Power",
  ...
  "Mind's Eye": {
    "name": "Mind's Eye",
    "description": "Ignores opponent's Evasiveness, and allows Normal- and Fighting-type attacks to hit Ghosts.",
    "generation": "9"
  },
  "Minus": {
    "name": "Minus",
  ...
  "Supersweet Syrup": {
    ...
    "description": "Lowers opponent's Evasiveness when entering battle.",
    "generation": "9"
  },
  "Supreme Overlord": {
  ...
  "Tera Shell": {
    "name": "Tera Shell",
    "description": "Moves are not very effective when HP is full.",
    "generation": "9"
  },
  "Tera Shift": {
    "name": "Tera Shift",
    "description": "Transforms into Terastal Form in battle.",
    "generation": "9"
  },
  "Teraform Zero": {
    "name": "Teraform Zero",
  ...
  "Toxic Chain": {
    "name": "Toxic Chain",
    "description": "May cause bad poisoning.",
    "generation": "9"
  },
  "Toxic Debris": {
    "name": "Toxic Debris",
...
if (typeof window !== "undefined") window.AbilitiesData = AbilitiesData;
